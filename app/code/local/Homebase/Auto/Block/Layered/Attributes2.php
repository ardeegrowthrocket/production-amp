...
class Homebase_Auto_Block_Layered_Attributes2 extends Mage_Core_Block_Template{
    ...
    protected function _getCollection()
    {
        if(!$this->_collection) {
            ...
            if(empty(Mage::registry('sub_category_meta'))){
                Mage::register('sub_category_meta',array_rand($this->_partNames,3),true);
            }
