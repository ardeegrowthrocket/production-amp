...
class Amasty_Audit_Adminhtml_Amaudit_AjaxController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('system/amauditmenu/preview');
    }
}
