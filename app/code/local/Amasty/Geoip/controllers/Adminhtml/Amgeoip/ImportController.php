...
class Amasty_Geoip_Adminhtml_Amgeoip_ImportController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function startAction()
    {
        ...
        try {
            ...
            if ($action == 'import') {
                $filePath = $geoIpModel->getCsvFilePath($type, $action);
            } else {
    ...
    public function processAction()
    {
        ...
        try {
            ...
            $allowedTableTypes = array('block', 'location');
            ...
            if ($action == 'import') {
                $filePath = $import->getCsvFilePath($type, $action);
            } else {
        ...
        try {
            ...
            if (file_exists($newFilePath)) {
                ...
                if ($hashUrl
                    ...
                    && Mage::getModel('amgeoip/import')->isDone()
                ) {
                    $needToUpdate = false;
                } else {
                    unlink($newFilePath);
