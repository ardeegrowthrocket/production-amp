    ...
    var app = {
                    ...
                    success: function(result) {
                        ...
                        if(result){
                            $.each(result.interlink, function (index, data) {
                                ymmInterlinkContainer.append("<div class=\"product-noimage-container col-lg-5ths col-sm-4 col-xs-12\">\n" +
                                    "                        <a href=\"" + data.link + "\">" + data.label + "<span class=\"arrow\"><i class=\"fa fa-caret-right\"></i></span>\n" +
                                    "                        </a>\n" +
                                    "                    </div>");
                            });
        ...
        'vehicleChecker': {
            ...
            'init' :  function (elemWrapper) {
                ...
                let $elemWrapper = $(elemWrapper);
                let $makerId = $elemWrapper.attr('data-make');
        ...
        'init': function () {
            ...
            app.owlCarouselCustom('.must-have', 5);
