...
class AtenExporterForMagento
{
	...
	const CONFIG_FILE = 'exportvip_config.php';
	...
	?><!DOCTYPE html><html lang="en"><head>
		...
		<title>VIP Product Exports</title>
		<link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">
	</head><body><div class="container">
		<h2><a href="#">VIP Product Exports</a></h2><?php
	}
	...
	?>
		...
		<fieldset class="form-group"><legend>Select product export options</legend>
			...
			<div class="checkbox">
				<label for="DownloadAsAttachment"><input type="checkbox" checked='checked' id="DownloadAsAttachment" name="DownloadAsAttachment" /> Check to download as a file (otherwise, the data will be displayed in your browser)</label>
			</div>
		</fieldset>
